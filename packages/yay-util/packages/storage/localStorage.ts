...
var index = {
    ...
    set: function set(arg1, arg2) {
         ...
         * @param v
         */
        var setVal = function setVal(n, v) {
         ...
         * @param obj
         */
        var setValByObj = function setValByObj(obj) {
        ...
        if (len(args) === 1 && isObject(args[0])) {
            ...
            if (isFunction(args[1])) {
                ...
                setValByObj((_setValByObj = {}, _setValByObj[key] = args[1](this.get(key)), _setValByObj));
            } else {
                // @ts-ignore
